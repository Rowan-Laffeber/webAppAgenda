    ...
    <div class="w-full max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl shadow-indigo-100/50 border border-slate-100 flex flex-col md:flex-row overflow-hidden">
        ...
        <div class="w-full md:w-64 bg-slate-50 border-b md:border-b-0 md:border-r border-slate-100 p-4 flex flex-col gap-2">
            ...
            <a href="{{ route('profile.index') }}"
               class="w-full bg-slate-900 text-white px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-widest text-center md:text-left">
                My Profile
            </a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center gap-6 pb-6 border-b border-slate-100">
                        ...
                        <div class="relative w-24 h-24 rounded-full border-2 border-slate-300 bg-slate-50 flex items-center justify-center overflow-hidden flex-shrink-0">
                            <svg class="absolute w-full h-full text-slate-300"
                                 viewBox="0 0 100 100"
                                 stroke="currentColor"
                                 stroke-width="1.5">
                    ...
                    <div class="flex flex-col gap-3 pt-4">
                        ...
                        <a href="{{ route('profile.edit') }}"
                           class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-xl text-sm font-semibold text-center">
                            Bewerk Gegevens/Wijzig Wachtwoord
                        </a>
                        <form action="{{ route('profile.destroy') }}"
                              method="POST"
                              onsubmit="return confirm('Weet je zeker dat je jouw account wilt verwijderen? Dit kan niet ongedaan worden gemaakt.')">

                            @csrf
                            @method('DELETE')

                            <button type="submit"
                                    class="w-full bg-red-50 hover:bg-red-100 text-red-600 px-4 py-3 rounded-xl text-sm font-semibold border border-red-100">
                                Delete Account
                            </button>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between bg-slate-50 border border-slate-200 rounded-xl px-4 py-3">
                        ...
                        <button type="button"
                                class="bg-slate-200 relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent">
                            <span class="translate-x-0 inline-block h-5 w-5 transform rounded-full bg-white shadow"></span>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center justify-between bg-slate-50 border border-slate-200 rounded-xl px-4 py-3">
                        ...
                        <div class="w-6 h-6 rounded-md bg-indigo-600 border border-slate-300 shadow-sm"></div>
                    </div>
